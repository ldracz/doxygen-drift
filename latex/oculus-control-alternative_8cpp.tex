...
\item 
Eigen\+::\+Vector3d \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\+\_\+position} (0.\+0, 0.\+0, 1.\+0)
...
)}\hypertarget{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{}\label{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}
...
\begin{DoxyCode}
89 \{
90   ros::init(argc, argv, \textcolor{stringliteral}{"oculus\_control\_alternative"});
91   ros::NodeHandle nh;
92 
93   \hyperlink{oculus-control-alternative_8cpp_a090c0766fbb77862dd8cc0cca99d688b}{traj\_msg}.header.stamp = ros::Time::now();
94 
...
96 
97   \hyperlink{oculus-control-alternative_8cpp_a92b67ae724bc0d23b8e85e92e89403df}{pub\_traj} = nh.advertise<trajectory\_msgs::MultiDOFJointTrajectory>(\textcolor{stringliteral}{"/firefly/command/trajectory"}, 
      1);
98 
...
Tilting in the y-\/axis when past a threshold will turn the drone left or right. Tilting in the x-\/axis when past a threshold will move the drone forward based on the current orientation of the drone. Tilting in the z-\/axis when past a threshold will move the drone left or right.
...
56     \hyperlink{oculus-control-alternative_8cpp_a03a69ef33d756512293e67791ab5f265}{desired\_yaw} = \hyperlink{oculus-control-alternative_8cpp_a03a69ef33d756512293e67791ab5f265}{desired\_yaw} - \hyperlink{oculus-control-alternative_8cpp_a7f7e4724cf57d59513b39c5ecc81adc8}{speed}/3;
57   \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (msg->y > 0.2) \{
58     \hyperlink{oculus-control-alternative_8cpp_a03a69ef33d756512293e67791ab5f265}{desired\_yaw} = \hyperlink{oculus-control-alternative_8cpp_a03a69ef33d756512293e67791ab5f265}{desired\_yaw} + \hyperlink{oculus-control-alternative_8cpp_a7f7e4724cf57d59513b39c5ecc81adc8}{speed}/3;
59   \}
60 
61   \textcolor{keywordflow}{if} (msg->x < -0.25) \{
62     \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.x() = \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.x() + 
...
63     \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.y() = \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.y() + 
...
64   \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (msg->x > 0.25) \{
65     \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.x() = \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.x() - 
      \hyperlink{oculus-control-alternative_8cpp_a7f7e4724cf57d59513b39c5ecc81adc8}{speed}*cos(\hyperlink{oculus-control-alternative_8cpp_a03a69ef33d756512293e67791ab5f265}{desired\_yaw});
66     \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.y() = \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.y() - 
      \hyperlink{oculus-control-alternative_8cpp_a7f7e4724cf57d59513b39c5ecc81adc8}{speed}*sin(\hyperlink{oculus-control-alternative_8cpp_a03a69ef33d756512293e67791ab5f265}{desired\_yaw});
67   \}
68 
69   \textcolor{keywordflow}{if} (msg->z < -0.25) \{
70     \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.x() = \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.x() + 
...
71     \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.y() = \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.y() + 
...
72   \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (msg->z > 0.25) \{
73     \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.x() = \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.x() - 
      \hyperlink{oculus-control-alternative_8cpp_a7f7e4724cf57d59513b39c5ecc81adc8}{speed}*cos(\hyperlink{oculus-control-alternative_8cpp_a03a69ef33d756512293e67791ab5f265}{desired\_yaw}-\hyperlink{oculus-control-alternative_8cpp_a2cce9b626fdb3b1f78baad955bd5b609}{ninetyDegInRad});
74     \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.y() = \hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position}.y() - 
      \hyperlink{oculus-control-alternative_8cpp_a7f7e4724cf57d59513b39c5ecc81adc8}{speed}*sin(\hyperlink{oculus-control-alternative_8cpp_a03a69ef33d756512293e67791ab5f265}{desired\_yaw}-\hyperlink{oculus-control-alternative_8cpp_a2cce9b626fdb3b1f78baad955bd5b609}{ninetyDegInRad});
75   \}
76 
77   mav\_msgs::msgMultiDofJointTrajectoryFromPositionYaw(\hyperlink{oculus-control-alternative_8cpp_a608d9948c063034b7605598daaeccc3e}{desired\_position},
78       \hyperlink{oculus-control-alternative_8cpp_a03a69ef33d756512293e67791ab5f265}{desired\_yaw}, &\hyperlink{oculus-control-alternative_8cpp_a090c0766fbb77862dd8cc0cca99d688b}{traj\_msg});
79   \hyperlink{oculus-control-alternative_8cpp_a92b67ae724bc0d23b8e85e92e89403df}{pub\_traj}.publish(\hyperlink{oculus-control-alternative_8cpp_a090c0766fbb77862dd8cc0cca99d688b}{traj\_msg});
80 
81 \}
\end{DoxyCode}
